			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						...
						<li><a class="nav-link" href="cart.blade.php"><img src="images/cart.svg"></a></li>
					</ul>
				</div>
			</div>
                      ...
                      <tbody>
                        <tr>
                          <td class="product-thumbnail">
                            <img src="images/tukkot.jpeg" alt="Image" class="img-fluid">
                          </td>
                        ...
                        <tr>
                          <td class="product-thumbnail">
                            <img src="images/lak-lak.jpeg" alt="Image" class="img-fluid">
                          </td>
                          <td class="product-name">
